...
export const fundingPrograms: FundingProgram[] = [
  ...
  {
    id: 'investitii-deficit-comercial-industrie',
    title: 'Investiții în industria prelucrătoare',
    officialName: 'Schema de ajutor de stat privind stimularea investițiilor în vederea realizării de produse cu deficit comercial semnificativ din industria prelucrătoare.',
    category: 'Ajutor de stat · Industria prelucrătoare',
    status: 'Urmează',
    description: 'Ajutor regional pentru investiții industriale inițiale de minimum 50 milioane lei, orientate către produse fabricate în România și reducerea deficitului comercial.',
    image: 'images/programs/investitii-deficit-comercial-industrie.svg',
    imageAlt: 'Fabrică modernă automatizată pentru realizarea de produse industriale cu deficit comercial',
    funding: '30%–70% ajutor regional',
    cofinancing: 'Minimum 25% fără ajutor public',
    deadline: 'Program în pregătire. Acordurile pentru finanțare pot fi emise în perioada 2026–2032; fiecare sesiune va fi anunțată cu minimum 30 de zile înainte și va avea o durată de 30 de zile lucrătoare',
    keyFacts: [
      ['Investiție eligibilă', 'min. 50 mil. lei'],
      ['Intensitate regională', '30%–70%'],
      ['Bugetul schemei', 'aprox. 1,05 mld. euro'],
      ['Beneficiari estimați', 'până la 200'],
    ],
    eligibility: [
      'Pot aplica întreprinderi în activitate și întreprinderi nou-înființate care realizează în România o investiție inițială într-un sector din lista celor 224 de coduri CAEN Rev. 3 eligibile.',
      'Întreprinderile în activitate trebuie să aibă rentabilitatea cifrei de afaceri mai mare decât zero în cel puțin unul dintre ultimele trei exerciții financiare și capitaluri proprii pozitive în ultimul exercițiu încheiat.',
      'Întreprinderile nou-înființate trebuie să aibă capital social subscris și vărsat de minimum 100.000 lei și să respecte condiția privind istoricul asociaților sau acționarilor pentru activitatea finanțată.',
      'Solicitantul nu trebuie să fie întreprindere în dificultate, insolvență, faliment, lichidare sau executare silită și nu trebuie să aibă un ajutor de stat/de minimis nerecuperat.',
      'Se solicită finanțare pentru o singură activitate economică, respectiv un singur cod CAEN, principal sau secundar.',
      'Investiția trebuie să aibă costuri eligibile fără TVA de minimum 50 milioane lei și să nu fie demarată înainte de depunerea cererii de acord pentru finanțare.',
    ],
    process: [
      'Verificarea codului CAEN Rev. 3, a produsului CPA aferent și a grupei de deficit comercial care poate aduce punctaj.',
      'Alegerea locației și a tipului de investiție inițială, dimensionarea bugetului și estimarea intensității regionale a ajutorului.',
      'Definirea fluxului industrial, a gradului de automatizare și a obiectivului de mediu: eficiență energetică, decarbonare, economie circulară sau prevenirea poluării.',
      'Pregătirea planului de afaceri, a proiecțiilor financiare, a documentelor privind locația, cofinanțarea și vânzarea produselor rezultate.',
      'Depunerea în sesiunea anunțată de Ministerul Finanțelor; cererile sunt ordonate descrescător după punctaj și analizate în limita bugetului alocat.',
      'După acord, investiția trebuie demarată în maximum șase luni, iar activele sau lucrările aferente demarării trebuie să reprezinte minimum 3% din valoarea totală a investiției.',
    ],
    eligibleCosts: [
      'Construcții de orice tip necesare investiției inițiale și active corporale reprezentând instalații tehnice, mașini, utilaje și echipamente noi.',
      'Active necorporale amortizabile precum brevete, licențe, know-how sau alte drepturi de proprietate intelectuală, în limita a 20% din costurile eligibile.',
      'Costurile eligibile sunt calculate fără TVA, iar activele trebuie achiziționate în condiții de piață, transparență și competitivitate.',
      'Echipamentele trebuie să contribuie la o îmbunătățire măsurabilă de mediu: reducerea consumului de energie cu minimum 20%, a emisiilor de CO₂ cu minimum 15% sau a consumului de materii prime/deșeurilor cu minimum 10%, ori prevenirea poluării.',
      'În cazul schimbării fundamentale a procesului de producție, costurile eligibile trebuie să depășească amortizarea activelor relevante din ultimele trei exerciții financiare.',
      'În cazul diversificării producției unei unități existente, costurile eligibile trebuie să depășească cu minimum 200% valoarea contabilă a activelor reutilizate.',
    ],
    obligations: [
      'Beneficiarul asigură o contribuție financiară de minimum 25% din costurile eligibile, din resurse proprii sau finanțare externă, fără alt ajutor public.',
      'Investiția, activitatea și activele finanțate trebuie menținute în regiune pentru minimum cinci ani de la finalizarea investiției.',
      'Proiectul trebuie să demonstreze eficiență economică și viabilitate pe durata implementării și pentru cinci ani după finalizare.',
      'Activele sunt exploatate exclusiv de beneficiar în locația proiectului și trebuie să fie amortizabile, înregistrate în patrimoniu și achiziționate în condiții de piață.',
      'Condițiile care au generat punctaj — produsul cu deficit, gradul de automatizare și ponderea materiilor prime din SEE — trebuie confirmate și menținute conform documentației finale.',
      'Investiția trebuie finalizată conform calendarului aprobat, cel târziu până la 31.12.2037, cu respectarea regulilor de cumul și evitare a dublei finanțări.',
    ],
    sources: [],
  },
];
...
export const fundingStatusStyles: Record<FundingStatus, string> = {
  Activ: 'border-[#b9e769]/55 bg-[#b9e769] text-[#073d2c]',
  'Urmează': 'border-white/35 bg-white text-[#073d2c]',
  'În implementare': 'border-[#073d2c] bg-[#073d2c] text-white',
  'Închis': 'border-[#073d2c]/10 bg-[#073d2c]/7 text-[#073d2c]/58',
};
